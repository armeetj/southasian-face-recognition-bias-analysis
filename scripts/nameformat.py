...
scramble_file_names("./data2/gujrat/in/male/")
rename_data("./data2/gujrat/in/male/", "male_in_")
scramble_file_names("./data2/gujrat/in/female/")
rename_data("./data2/gujrat/in/female/", "female_in_")
print("-- COMPLETE --")
