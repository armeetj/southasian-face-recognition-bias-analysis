...
scramble_file_names("./data2/north_ladakh/in/male/")
rename_data("./data2/north_ladakh/in/male/", "male_in_")
scramble_file_names("./data2/north_ladakh/in/female/")
rename_data("./data2/north_ladakh/in/female/", "female_in_")
print("-- COMPLETE --")